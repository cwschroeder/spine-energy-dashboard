...
export function LeafletMapFixed({ devices }: LeafletMapProps) {
  ...
  // Debug logging
  console.log('Devices with location:', devicesWithLocation.map(d => ({
    id: d.device_id,
    alias: d.alias,
    hasAlias: !!d.alias && d.alias.trim() !== ''
  })));
      ...
      <div className="w-80 bg-white border-l overflow-auto">
        ...
        <div className="p-4">
          ...
          {devicesWithLocation.length > 0 && (
            <div className="mb-4">
              <h4 className="text-xs font-semibold text-gray-600 mb-2">Mit Standortdaten</h4>
              <div className="space-y-2">
                {devicesWithLocation.map((device) => {
                  const displayAlias = device.alias && device.alias.trim() !== '' && device.alias !== 'null';
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs text-gray-500 mt-0.5">
                            {getStatusText(device.signal)}
                            {device.report?.signalStrength && ` • ${device.report.signalStrength} dBm`}
                          </div>
                        </div>
                      </div>
                    </div>
